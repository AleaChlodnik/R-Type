...
class Rtype {
  ...
  public:
    Rtype();    // This will init the player. Default easy mode and normal
    ...
    void
    handleEvents(); // This is where I will handle the events for the window &
                    // player (key input, etc.). When key is pressed, move
                    // player, and send new player info to server.
    void processServerMessages(); // This is where I will process the info from
                                  // the server.
    void
